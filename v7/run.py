...
from v7.function.api_client import create_api_client
...
class MultiAgentSystem:
    ...
    def _setup_conversation_summary(self):
        ...
        try:
            ...
            # 创建摘要模型配置
            from v7.function.middleware import ModelConfig
            summary_model_config = ModelConfig(
                ...
                max_tokens=self.config.agent.get("max_tokens_summary_model", 2000),
            )
...
if __name__ == '__main__':
    ...
    api_student = 'gpt-3.5-turbo-0125'  # GOOD imitator in temp 0: gpt-3.5-turbo-0125
    api_teacher = 'deepseek-chat'

    if 'deepseek' not in api_student:
