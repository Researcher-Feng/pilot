...
if __name__ == '__main__':
    ...
    overrides.append('+model.temperature_student=0.2')
    ...
    overrides.append('+model.temperature_summary_model=0.2')
    ...
    -----------------------------------
    '''
    overrides.append('+agent.parallel_thinking=true')                 # 学生并行思考能力
    ...
    overrides.append('+agent.teacher_sys_prompt=TEACHER_PROMPT')  # 选择教师系统提示词
    ...
    overrides.append('+agent.math_background=None')                    # 数学背景
