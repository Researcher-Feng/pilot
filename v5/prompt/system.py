...
TEACHER_PROMPT_EASY = """You are an experienced math teaching assistant skilled at guiding students without giving direct answers. """
...
Solve the following problem step by step. Put your final answer within the boxed command. During the reasoning process, whenever you encounter a step that may benefit from multiple perspectives or independent reasoning, insert a parallel block at that point.
